           ...
           <div class="modal-dialog">
             <div class="modal-content">
               <div class="modal-header">
                        <b><h4>Deactivate Recipe - <?php ?> //name of recipe</h4></b>
                         
                </div>
               <div class="modal-body">
                    <form action="#" method="post" role="form" name="replenishTable">
                         <table id="deactivateTable" class="table table-bordered table-hover" name="deactivateTable">
                          <tbody>
                            <td align="center">
                ...
                <form class="form-horizontal" action="#" method="POST">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="InputRecipeID" class="col-sm-2 control-label">Search Recipe</label>
                      <div class="col-sm-8">
                        <input type="name" class="form-control" id="InputStockCode" placeholder="Enter recipe name">
                      </div>
                    </div>
                    ...
                    <tbody>
                       ...
                       <?php
                        ...
                        while ($row = mysqli_fetch_array($sql)){
                          ...
                          echo '<td>  <button type="button" class="btn btn-block btn-default btn-sm" data-toggle="modal" data-target="#deactivate" aria-hidden="true">Deactivate</button></td>'; 
                          echo "</tr>";
