           ...
           <div class="modal-dialog">
             <div class="modal-content">
               <div class="modal-header">
                        <b><h3>Edit Stock</h3></b>
                         
                </div>
               <div class="modal-body">

                 <form class="form-horizontal" action="replenishstock1.php"  method="post" role="form" name="editTable">
                  <div class="box-body">
                      ...
                      value="<?php if (isset($_POST['type']) && !$flag) echo $_POST['type']; ?>">
                       ...
                       <div class="form-group">
                      <label for="inputdtReceived" class="col-sm-2 control-label">Item Name</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputdtReceived" required>
                      </div>
                    </div>
                       <div class="form-group">
                      <label for="inputdtReceived" class="col-sm-2 control-label">Quantity</label>
                      <div class="col-sm-10">
                        <input type="number" class="form-control" id="inputdtReceived" required>
                      </div>
                    </div>
            ...
            <div class="col-xs-10">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><b>EDIT STOCK</b></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <tbody>
                       ...
                       <?php
                        ...
                        while ($row = mysqli_fetch_array($sql)){
                          ...
                          echo '<td>  <button type="button" class="btn btn-block btn-default btn-sm" data-toggle="modal" data-target="#edit" aria-hidden="true">Edit</button></td>'; 
                          echo "</tr>";
